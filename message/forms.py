...
from wtforms import StringField, PasswordField, SubmitField, BooleanField, TextAreaField, SelectMultipleField, widgets, SelectField, FileField, MultipleFileField, EmailField
...
class NewUserForm(FlaskForm):
    ...
    email = EmailField("Email ID",render_kw={"placeholder":"Your Email ID (optional)"})
    # email = StringField()
